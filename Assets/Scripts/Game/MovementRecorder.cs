...
public class MovementRecorder : MonoBehaviour {
	...
	void Update () {
        if (this.fileSet)
        {
			...
			//rewardFile.Write ("Rewards:" + rewards + ";Licks:" + licks + ";" + System.DateTime.Now.Hour + "-" + System.DateTime.Now.Minute + "-" + System.DateTime.Now.Second +System.Environment.NewLine);
