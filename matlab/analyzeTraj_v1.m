...
% type is also shown in thick black (TODO).
%
    ...
    for d_i=1:length(days)  % Iterate through all of the specified days
        ...
        for r_i=1:length(actRecs{1})
            ...
            if (trialTypeStrArr(tt_i) == "*->*" || ...
                ...
                (stimLocX == leftNearX && trialTypeStrArr(tt_i) == "LN->*") || ...
                (stimLocX == leftNearX && actionLocX == leftNearX && trialTypeStrArr(tt_i) == "LN->LN") || ...
                (stimLocX == leftNearX && actionLocX == rightNearX && trialTypeStrArr(tt_i) == "LN->RN") || ...
                (stimLocX == leftNearX && actionLocX == leftFarX && trialTypeStrArr(tt_i) == "LN->LF") || ...
                (stimLocX == leftNearX && actionLocX == rightFarX && trialTypeStrArr(tt_i) == "LN->RF") || ...
                (stimLocX == rightNearX && trialTypeStrArr(tt_i) == "RN->*") || ...
                (stimLocX == rightNearX && actionLocX == leftNearX && trialTypeStrArr(tt_i) == "RN->LN") || ...
                (stimLocX == rightNearX && actionLocX == rightNearX && trialTypeStrArr(tt_i) == "RN->RN") || ...
                (stimLocX == rightNearX && actionLocX == leftFarX && trialTypeStrArr(tt_i) == "RN->LF") || ...
                (stimLocX == rightNearX && actionLocX == rightFarX && trialTypeStrArr(tt_i) == "RN->RF") || ...
                (stimLocX == leftFarX && trialTypeStrArr(tt_i) == "LF->*") || ...
                (stimLocX == leftFarX && actionLocX == leftNearX && trialTypeStrArr(tt_i) == "LF->LN") || ...
                (stimLocX == leftFarX && actionLocX == rightNearX && trialTypeStrArr(tt_i) == "LF->RN") || ...
                (stimLocX == leftFarX && actionLocX == leftFarX && trialTypeStrArr(tt_i) == "LF->LF") || ...
                (stimLocX == leftFarX && actionLocX == rightFarX && trialTypeStrArr(tt_i) == "LF->RF") || ...
                (stimLocX == rightFarX && trialTypeStrArr(tt_i) == "RF->*") || ...
                (stimLocX == rightFarX && actionLocX == leftNearX && trialTypeStrArr(tt_i) == "RF->LN") || ...
                (stimLocX == rightFarX && actionLocX == rightNearX && trialTypeStrArr(tt_i) == "RF->RN") || ...
                (stimLocX == rightFarX && actionLocX == leftFarX && trialTypeStrArr(tt_i) == "RF->LF") || ...
                (stimLocX == rightFarX && actionLocX == rightFarX && trialTypeStrArr(tt_i) == "RF->RF"))
        ...
        for r_i=trialsToDo 
            ...
            if ((isCorrectionTrial && ~includeCorrectionTrials) || (isCatchTrial && ~includeCatchTrials) || ...
                    (isExtinctionTrial &&  )
