...
% At this setting (3.5), observe range of times as low as 3.76x and as high as 5.65x
elseif (etime(d.AbsTime, lastEventTime) > 1/fps * 3.5) 
    d.TimeSinceLastEvent = etime(d.AbsTime, lastEventTime);
