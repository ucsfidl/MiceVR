function nasalExtrema = plotTargetAzimLoc(mouseName, days, sessions, trials, trialTypeStrArr, denoiseBallMovement, useFieldRestriction, useEyeTracking, whichEye, interactive)
